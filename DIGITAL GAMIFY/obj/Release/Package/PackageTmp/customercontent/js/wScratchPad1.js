 ...
 * @license         This wScratchPad1 jQuery plug-in is dual licensed under the MIT and GPL licenses.
 * @link            http://www.websanova.com
 * @github			http://github.com/websanova/wScratchPad1
 * @version         Version 1.4.4
 *
 ******************************************/

(function ($) {
    $.fn.wScratchPad1 = function (option, settings) {
        ...
        settings = $.extend({}, $.fn.wScratchPad1.defaultSettings, settings || {});
        ...
        return this.each(function () {
            ...
            elem.data('_wScratchPad1', sp);

            sp.init();
        });
    };

    $.fn.wScratchPad1.defaultSettings =
	{
	    width: 500,					// set width - best to match image width
	    height: 300,					// set height - best to match image height
    ...
    ScratchPad.prototype =
	{
	    ...
	    init: function () {
	        ...
	        this.pixel = this.canvas.width * this.canvas.height;
